...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        if s in self.corners:
            ...
            #print(visited)
            return len(visited) == 4 ## return True if all 4 corners are reached
        return False
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                # Add node to the Visited corner list if it is a corner 
...
def cornersHeuristic(state, problem):
    ...
    while(len(unvisited)!=0):
        distance, corner = min( [(util.manhattanDistance(cur_position ,corner),corner) for corner in unvisited] )
        h_sum = h_sum + distance
        cur_position = corner
        unvisited.remove(cur_position) 
